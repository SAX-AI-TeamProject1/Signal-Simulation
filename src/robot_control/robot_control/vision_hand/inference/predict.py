...
from robot_control.vision_hand.capture.extractor import (
    HAND_DIM,
    FeatureExtractor,
    HandWarning,
    LensHealthMonitor,
...
from robot_control.vision_hand.inference.ui import Hud # 확률 패널·한글 오버레이·창 표시 전담 (predict.py는 예측 로직만)
from robot_control.vision_hand.inference.publish import make_publisher
from robot_control.vision_hand.training.train import SignLSTM
